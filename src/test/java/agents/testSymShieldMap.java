    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            for (int i = 0; i < allyBotAlive; i++) {
                ...
                if (turn == 83 && selfId % 7 == 2) {
                    System.err.println(shieldMap.get(selfId) + " " + accDist + " " + attackersMap.getOrDefault(selfId, new HashSet<>()).size());
                }
