...
/**
 * The DebugOnHoverModule allows you to display debug entities when the mouse is over an entity. It's the same as the
 * TooltipModule, but for other things than text.
 */
@Singleton
