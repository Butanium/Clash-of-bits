            ...
            if (showing.length) {
                ...
                for (let show of showing) {
                    ...
                    if (state !== null) {
                        ...
                        const wrappedText = module.currentFrame.registered[show];
                        const splitedText = wrappedText.split(" ");
                        let action;
                        if (splitedText[5].charAt(0) === 'I') {
                            action = 'IDLE';
                        } else {
                            action = actionDic[splitedText[5].charAt(0)] + ' ' + splitedText[5].substr(1);
                        }
